            ...
            <ul className="flex gap-8 font-xl">
              <li>
                <a
                  ...
                  className="hover:text-white/75 transition focus:text-white/75"
                >
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/nickvanmeter"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-white/75 transition focus:text-white/75"
                >
            ...
            <div className="h-full w-full gridded flex items-center ">
              <div className="relative w-full md:max-w-260 ml-auto md:px-24 px-6 text-center md:text-left pt-24 pb-8 md:pt-0 md:pb-0">
                ...
                font-display  tracking-tighter inline-block"
                  >
                    nick
                    <br className="hidden md:block" /> vanmeter
                  </span>
                  <div
                    className="w-full flex justify-between text-left text-slate-500
          ...
          <div className="col-span-4 md:col-span-1 lg:col-span-1 bg-[#7A4D9F] max-h-[200px] md:max-h-full md:h-full flex items-center order-1 md:order-2 py-18 md:py-0">
            <div className="gridded h-full w-full flex items-center">
              <div className="w-full md:max-w-100 text-center">
                <Image
                  src="/avatar.png"
                  alt="nick vanmeter profile photo"
                  width={400}
                  height={400}
                  className="relative md:-left-1/2 inline translate-y-[38%] md:translate-y-0 md:mb-0 md:w-auto max-w-full w-[200px] rounded-full md:rounded"
                />
              </div>
            </div>
          </div>
          ...
          <div className="col-span-4 space-y-12">
            <div className="space-y-4 max-w-3xl mx-auto">
              <div className="text-center space-y-2 flex flex-col items-center justify-center mb-12">
                <p className="rounded font-bold md:text-5xl sm:text-3xl text-xl font-display bg-slate-800 text-white px-2 inline-block">
                  senior front-end engineer
                </p>
                <p className="rounded font-bold md:text-2xl sm:text-xl text-md font-display bg-slate-800 text-white px-2 inline-block">
                  user experience, design & development
                </p>
                <p className="rounded font-bold md:text-sm sm:text-xs text-xs font-display bg-slate-800 text-white px-2 inline-block">
                  (and dogs, sourdough, trails & crochet)
                </p>
              </div>
              <div className="px-4 lg:px-0 space-y-4">
                <p>
                  From SaaS products and e-commerce sites to developer tools,
                  I&apos;m all about crafting smooth, intuitive user
                  experiences. Working with a team of product managers/owners,
                  designers and other engineers is where I do my best work.
                </p>
                <p>
                  I&apos;m driven by the constantly evolving frontend landscape
                  (especially seeing AI pop up in user experiences in cool and
                  innovative ways). I enjoy tinkering with fun little projects
                  like what you see below — they&apos;re my playgrounds for
                  experimenting with interesting tech and creative product
                  ideas.
                </p>
              </div>
            </div>
